...
CHUNK_FILE = os.path.join(DATA_DIR, "chunks_for_manifestos_memformer.json")
RILE_FILE  = os.path.join(DATA_DIR, "RILE_by_chunk_memformer.json")
...
# Use a standard tokenizer (e.g. RoBERTa) for consistency
