...
chunk_file_path = "/mount/studenten-temp1/users/qbaibisa/party-positioning-code-master/data/chunks_for_manifestos_bigbird_semantic.json"
rile_path = "/mount/studenten-temp1/users/qbaibisa/party-positioning-code-master/data/RILE_by_chunk_bigbird_semantic.json"
...
def segment_manifesto(sentences, max_chunk_size=4095, sim_threshold=0.7):
    ...
    for i in range(1, len(sentences)):
        ...
        # Start a new segment if similarity is low
